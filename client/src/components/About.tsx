...
import { CheckCircle2, BarChart3, ShieldCheck, FileText, ArrowRight } from "lucide-react";
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed text-lg">
            ...
            {preview && (
              <Button asChild variant="link" className="px-0 text-accent font-bold text-base mt-2">
                <Link href="/about">
        ...
        {preview && (
          <div className="relative">
             <div className="absolute inset-0 bg-gradient-to-r from-transparent to-white z-10 md:block hidden"></div>
